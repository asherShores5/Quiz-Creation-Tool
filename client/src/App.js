    ...
    <BrowserRouter>
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route path="join" element={<JoinPage />} />  {/* lets find a quiz  */}
          <Route path="join/search" element={<SearchQuiz />} /> {/* waiting to join, find quiz  */}
          <Route path="join/login" element={<JoinLogin />} /> {/* find quiz  */}
